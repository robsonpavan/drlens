			...
			<div class="col-md-3 col-sm-6">
				<div class="footer-about-us">
					...
					<div class="footer-social">
						<a href="https://www.facebook.com/robson.alvespavan" target="_blank"><i class="fa fa-facebook"></i></a>
						<a href="https://x.com/robsonp1407" target="_blank"><i class="fa fa-twitter"></i></a>
						<a href="https://www.youtube.com/channel/UCCMYidMlo9IW-t0zDCTcJ1Q" target="_blank"><i class="fa fa-youtube"></i></a>
					</div>
				</div>
			</div>
...
<div class="footer-bottom-area">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<div class="copyright">
					<p>&copy; 2024 RAP Informática. <a href="http://robsonpavan.com.br" target="_blank">robsonpavan.com.br</a></p>
				</div>
			</div>
