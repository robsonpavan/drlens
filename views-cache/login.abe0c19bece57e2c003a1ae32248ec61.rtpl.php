...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="/res/admin/index2.html" class="h1"><b>Dr</b>Lens</a>
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
        <a href="/admin/forgot">Eu esqueci minha senha</a>
      </p>
      <p class="mb-0">
        <a href="register.html" class="text-center">Criar novo usuários</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
